...
namespace RealEstateGUI_form
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            var builde = new MySqlConnectionStringBuilder { Server = "127.0.0.1", UserID = "root", Password = "", Database = "ingatlanok" };
            var connection = new MySqlConnection(builde.ConnectionString);
            connection.Open();
        ...
        {
            label2.Text = sellers[index].Name;
            label4.Text = sellers[index].Phone;
